...
- [Microservices - How to build modern applications with microservice architecture? (Persian)](https://nikamooz.com/product/microservice-book/) <small>(by Alireza Orumand) Winter, 2020</small>
